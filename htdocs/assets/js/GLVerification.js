...
var GLVerificationManagement = function () {
    ...
    self.glverification_dashboard_table = function(){
        ...
        {   "targets": 1, "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
            ...
            if (oData[0]==="Total"){
                $(nTd).html('<div style="width: 100%;" class="bd-darkgray text-right bgcolor-dark-grey"><span id="linkamountselected" style="width:60%;padding: 2px 5px;" class="display-inline dt-link"><u>'+ amountselected +'</u></span><span style="width:40%;border-left: 1px solid #999;padding: 2px 5px;" class="display-inline">'+ oData[4]+'</span></div>');
            }else{
                $(nTd).html('<div style="width: 100%;" class="bd-darkgray text-right bg-color-white"><span id="linkamountselected" style="width:60%;padding: 2px 5px;" class="display-inline  dt-link"><u>'+ amountselected +'</u></span><span style="width:40%;border-left: 1px solid #999;padding: 2px 5px;" class="display-inline">'+ oData[4]+'</span></div>');
            }
