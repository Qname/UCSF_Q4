<div class="modal-dialog" id="edit_user_content">
	<div class="modal-content">
		<div class="modal-header modal-header-custom">
			...
			<h4 class="modal-title modal-title-main" style="font-weight:bold;">Edit User and Role</h4>
		</div>
		<?php //echo validation_errors(); ?>
		<?php //echo form_open('/usersmanagement/edit/'.$user_item['id'],$attributes); ?>
			...
			<div class="modal-body row">
				<div class="col-lg-12">
					<fieldset style="margin-bottom:20px;">
						...
						<input type="hidden" name="id" value="<?php echo $user_item['id'];?>" id="id">
						<input type="hidden" name="user_id_old" value="<?php echo $user_item['user_id'];?>" id="id">
						<div class="textfield">
							<label class="control-label" style="width:30%;" for="user_id">UCSF ID: <span style="color:red;">*</span></label>
							<input type="text" readonly name="user_id" value="<?php echo $user_item['user_id'];?>" style="width:60%;" id="user_id" required>
						...
						<div class="textfield  padding-top-10">
							...
							<input type="text" readonly name="user_name" value="<?php echo $user_item['user_name'];?>" style="width:60%;" id="user_name" required>
							<div class="error-user-form" id="error_user_name"></div>
						</div>

						<div class="textfield padding-top-10">
							<label class="control-label" style="width:30%;" for="nameFirst">First Name</label>
							<input type="text" name="nameFirst" value="<?php echo $user_item['nameFirst'];?>" style="width:60%;" id="nameFirst" class="">
						</div>

						<div class="textfield padding-top-10">
							<label class="control-label" style="width:30%;" for="nameLast">Last Name</label>
							<input type="text" name="nameLast" value="<?php echo $user_item['nameLast'];?>" style="width:60%;" id="nameLast" class="">
						</div>

						<div class="textfield padding-top-10">
							<label class="control-label" style="width:30%;" for="email">Email</label>
							<input type="text" name="email" value="<?php echo $user_item['email'];?>" style="width:60%;" id="email" class="email">
						...
						<div class="textfield padding-top-10">
							...
							<input type="text" name="departmentname" value="<?php echo $user_item['departmentname'];?>" style="width:60%;" id="departmentname" class="">
						</div>
						...
						<fieldset>
							...
							<div class="textfield">
								...
								<div style="margin-left:30.4%;">
									...
									<span>
										<input aria-labelledby="lblAuthorized" type="radio" name="authorized_role" value="<?php echo $role->role_name;?>" <?php if($role->role_name == $user_item['authorized_role']) {echo "checked";}?> /><?php echo $role->role_name;?>
									</br>
								</span>
								<?php } ?>
							</div>
							...
							<div class="textfield padding-top-10" id="allowDeptDiv">
								...
								<input type="text" title="Enter Dept IDs separated by comma." name="allowDeptId" value="<?php echo $user_item['allowDeptId'];?>" style="width:60%;" id="allowDeptId" class="">
